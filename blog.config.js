...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2c81cd6146038189a70ede4fc52986dc',
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 180, // 更新缓存间隔 单位(秒)；即每个页面有60秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '冰哦', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '宇宙无敌大帅哥', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://allone.de5.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '冰的博客', // 网站关键词 英文逗号隔开
